#RESUMEN DE DATOS eBIRD PARA POLÍGONOS IBA

#establecer la carpeta donde R leerá y escribirá archivos para este proyecto
setwd("~/library/Mobile Documents/com~apple~CloudDocs/Desktop/ROC/IBAs/")#modificar la dirección e ingresar la carpeta que utilizará en su computador

#instalar paquetes requeridos 
install.packages('auk')#para lectura y manipulacion de base de datos de eBird
install.packages('tidyverse')#para todas funciones de manipulacion de datos
...
#ingresar la  dirección donde se encuentra el archivo de la base de datos de eBird en su computador
#esta dirección es la misma carpeta que fue definida más arriba, pero incluyendo el nombre del archivo de la base de datos al final
auk_set_ebd_path("~/ebd_CL_relJune-2022.txt",overwrite=FALSE)
